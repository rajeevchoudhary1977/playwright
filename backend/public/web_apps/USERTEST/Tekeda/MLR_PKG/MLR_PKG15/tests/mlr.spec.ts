...
await newPage.waitForSelector('#about', { timeout: 5000 }); 

await newPage.waitForSelector('#port-folio', { timeout: 5000 }); 

await newPage.waitForSelector('#help', { timeout: 5000 });

await newPage.waitForSelector('#contact', { timeout: 5000 });

await newPage.waitForSelector('#footser-end', { timeout: 5000 });
